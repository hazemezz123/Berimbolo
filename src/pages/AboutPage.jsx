...
const AboutPage = () => {
  ...
  return (
    <motion.main
      className="py-20 bg-deepPurple-darkest min-h-screen text-neutral-light font-JetBrains"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <div className="container mx-auto px-4">
        {/* Header Section */}
        <motion.h1
          className="text-5xl font-bold text-center mb-12 text-deepPurple-lightest"
        ...
        <div className="max-w-4xl mx-auto bg-deepPurple-dark p-8 rounded-lg shadow-lg border border-deepPurple-light">
          <motion.p
            className="text-xl mb-6 leading-relaxed text-deepPurple-accent"
          ...
          <motion.p
            className="text-lg mb-6 text-neutral-medium leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={index}
              className="p-6 bg-deepPurple-darker rounded-lg shadow-lg border border-deepPurple-lightest hover:scale-105 transition-all cursor-pointer"
              variants={{
                hidden: { opacity: 0, y: 20 },
                visible: { opacity: 1, y: 0 },
              }}
            >
              <h3 className="text-2xl font-semibold text-deepPurple-lightest mb-4">
                {feature.title}
              </h3>
        ...
        {/* Closing Section */}
        <motion.p
          className="text-center text-lg mt-12 text-neutral-medium"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
